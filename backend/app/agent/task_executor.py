...
После create_task — ОБЯЗАТЕЛЬНО проверь: есть ли в запросе сфера (работа, компания, проект, категория). Если да и её нет в «Известно о пользователе» — вызови update_user_profile.
